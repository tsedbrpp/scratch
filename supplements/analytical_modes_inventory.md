...
| 3 | **Ghost Node Detection (GNDP v1.0)** | Structural absence analysis (ANT-informed) | `ghost_nodes_combined_pass_1`, `ghost_nodes_pass_2`, GNDP Pass 1A–3 | `src/lib/ghost-nodes/` (11 files), `src/lib/prompts/gndp-v1.ts` | Weighted scores, evidence grades, ghost typology, counterfactuals |
