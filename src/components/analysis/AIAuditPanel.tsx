            ...
            {isExpanded && (
                <div className="mt-4 space-y-6 animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="bg-amber-50 border-l-4 border-amber-500 p-3 text-sm text-amber-900 font-mono shadow-sm">
                        <strong>⚠️ Epistemic Notice:</strong> This result was generated by a specific configuration of human choices materialized as code.
                        ...
                        <div className="flex justify-end gap-3">
                            {!isFlagging ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        <span>🏳️</span> Flag as Unacceptable (Negate)
                                    </button>
                                </div>
                            ) : (
