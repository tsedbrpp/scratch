...
const NODES = [
    ...
    { id: "abstract-machines", name: "Abstract Machines", nodeType: "tool", scaleDefault: "macro", scaleConfidence: 0.89, isOPP: false, isBoundaryObject: false, ttl_days: 90, freshness: 0.96, icon: "⚙️", antRole: "Structural Parser", desc: "Analyze the deep ontological blueprints of policies via double articulation and structuration.", theory: "Draws explicitly from Deleuze and Guattari's concept of the Abstract Machine. It reveals how assemblages are formalized across expression and content strata into structural blueprints, enabling differential comparison of rigidities.", hotspot: { entanglement: 0.82, grounding: 0.80, disagreement: 0.25, decay: 0.10 } }
];
...
const EDGES = [
    ...
    // abstract machines links
    { source: "abstract-machines", target: "data-sources", type: "grounds_in", label: "grounded in sources", directed: true },
    { source: "lens-config", target: "abstract-machines", type: "operationalizes", label: "lens → structural mapping", directed: true },
    { source: "abstract-machines", target: "cross-case-synthesis", type: "produces", label: "produces formal diff", directed: true }
];
    ...
    return (
        <div className="w-full h-[600px] lg:h-[800px] flex flex-col overflow-hidden bg-[#060d1a] text-[#c8d8f0] font-sans">
            ...
            <div className="flex flex-wrap items-center gap-2 px-4 py-1.5 bg-[#0a1628] border-b border-[#1a3050] text-[10px]">
                ...
                <span className="text-[#a070e0] font-semibold">Policy Prism Platform · Feature Assemblage</span>
