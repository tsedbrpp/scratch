...
interface CulturalHoleCardProps {
    hole: CulturalHole;
    clusters: Array<{ id: string; name: string; themes: string[] }>;
}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-center">
                    <div className="bg-white p-3 rounded-md border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-1">
                            {clusterA.themes.slice(0, 3).map((theme, i) => (
                    ...
                    <div className="bg-white p-3 rounded-md border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-1">
                            {clusterB.themes.slice(0, 3).map((theme, i) => (
                                <Badge key={i} variant="outline" className="text-xs">
                                    {theme}
                                </Badge>
                            ))}
                ...
                {hole.bridgingConcepts.length > 0 && (
                    <div className="bg-white p-3 rounded-md border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {hole.bridgingConcepts.map((concept, i) => (
                                <Badge
                                    key={i}
