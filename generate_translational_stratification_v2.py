"""
Translational Stratification Analysis – Three‑Stage Pipeline Diagram (v2)
...
def add_arrow(slide, x1, y1, x2, y2, color_hex, width=1.5, dashed=False, head=True):
    # Use a straight connector (native PowerPoint connector)
    ...
    if dashed:
        # Use the MSO_LINE_DASH_STYLE enum for dash patterns
...
run1 = para.add_run()
run1.text = 'Stable vocabularies travel, but local referents create inequity through layered compliance infrastructures.'
